...
public class CustomVideo extends GSYVideoPlayer {
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, CustomVideo.this);
        }
        prepareVideo();
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        CustomVideo sf = (CustomVideo) from;
        CustomVideo st = (CustomVideo) to;
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            ...
            CustomVideo customVideo = (CustomVideo) gsyBaseVideoPlayer;
            customVideo.loadCoverImage(mCoverOriginUrl, mDefaultRes);
        }
